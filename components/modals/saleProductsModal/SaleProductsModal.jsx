...
import {
  ...
  List,
  SelectedWarehouse,
} from "./SaleProductsModal.styled";

export const SaleProductsModal = () => {
  ...
  const onHandleSale = async () => {
    try {
      const response = await axios.post(
        `${process.env.NEXT_PUBLIC_SERVER}/document/sale`,
        {
          number,
